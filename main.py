...
parser.add_argument('--dataset_name', type=str, default='new_stairs', help='dataset name')
parser.add_argument('--dataset_dir', type=str, default='/home/yz3243/cgan/data', help='dataset directory')
